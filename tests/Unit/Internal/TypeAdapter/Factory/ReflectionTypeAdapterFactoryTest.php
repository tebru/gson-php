...
class ReflectionTypeAdapterFactoryTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        self::assertTrue($this->reflectionTypeAdapterFactory->supports(new PhpType(ChildClass::class)));
    }

    public function testNonClassSupports()
    {
        self::assertFalse($this->reflectionTypeAdapterFactory->supports(new PhpType('string')));
    }

    public function testCreate()
    {
        $adapter = $this->typeAdapterProvider->getAdapter(new PhpType(ChildClass::class));
